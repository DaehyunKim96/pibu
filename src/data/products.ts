...
export interface BrandProfile {
  /** 브랜드 포지션 분류 */
  segment: string
  /** 브랜드가 강하게 밀고 있는 케어 방향 */
  focus: string
  /** 제품을 고를 때 기대할 수 있는 성격 */
  character: string
  /** 대표 키워드 */
  tags: string[]
}
...
export const BRAND_PROFILES: Record<string, BrandProfile> = {
  라운드랩: {
    segment: '데일리 수분·저자극',
    focus: '미네랄 워터, 히알루론산, 판테놀 중심의 편안한 수분 케어',
    character: '자극을 낮춘 기본템 성격이 강해 토너와 선크림처럼 매일 쓰는 제품군에 잘 맞습니다.',
    tags: ['수분', '저자극', '데일리'],
  },
  아누아: {
    segment: '진정·트러블 밸런스',
    focus: '어성초를 앞세운 피지, 트러블, 붉음 진정',
    character: '유분이 많거나 트러블이 잦은 피부가 가볍게 진정 베이스를 깔 때 어울립니다.',
    tags: ['어성초', '진정', '피지'],
  },
  토리든: {
    segment: '속보습·수분 장벽',
    focus: '저분자 히알루론산과 베타글루칸으로 채우는 수분감',
    character: '활성 성분보다 수분 밀도와 진정감을 우선하는 브랜드로, 속건조 루틴에 넣기 좋습니다.',
    tags: ['히알루론산', '속건조', '진정'],
  },
  '스킨천사(SKIN1004)': {
    segment: '병풀 단순 진정',
    focus: '병풀 추출물과 마데카소사이드 기반의 성분 단순화',
    character: '예민해진 피부에 불필요한 변수를 줄이고 진정 성분을 집중해서 쓰는 방향입니다.',
    tags: ['병풀', '시카', '단순처방'],
  },
  넘버즈인: {
    segment: '기능성 타깃 케어',
    focus: '나이아신아마이드 기반 톤, 피지, 모공 동시 케어',
    character: '번호별 고민 해결형 컨셉이 강해 피부 고민이 명확할 때 선택하기 쉽습니다.',
    tags: ['톤케어', '모공', '피지'],
  },
  일리윤: {
    segment: '장벽 보습·가성비',
    focus: '세라마이드 중심의 대용량 장벽 보습',
    character: '얼굴과 몸에 넉넉히 바를 수 있는 실용적 보습 라인으로 건조, 장벽 약화에 강합니다.',
    tags: ['세라마이드', '보습', '대용량'],
  },
  에스트라: {
    segment: '더마 장벽·트러블',
    focus: '장벽 지질, 판테놀, 아젤라산을 활용한 피부과학 기반 케어',
    character: '민감 장벽 회복과 트러블 기능성 사이를 비교적 균형 있게 다루는 더마 성격입니다.',
    tags: ['더마', '장벽', '트러블'],
  },
  라로슈포제: {
    segment: '더마 리페어',
    focus: '판테놀과 마데카소사이드로 자극 부위를 덮어주는 회복 케어',
    character: '데일리 전체 사용보다 건조하고 헐거나 붉어진 부위의 집중 케어에 강점이 있습니다.',
    tags: ['리페어', '판테놀', '국소케어'],
  },
  코스알엑스: {
    segment: '문제 해결형 액티브',
    focus: 'BHA, 레티놀, 스네일 등 명확한 핵심 성분 중심',
    character: '보습부터 각질, 모공, 안티에이징까지 성분 목적이 선명해 단계적으로 도입하기 좋습니다.',
    tags: ['BHA', '레티놀', '스네일'],
  },
  썸바이미: {
    segment: '각질·트러블 액티브',
    focus: 'AHA, BHA, PHA 조합으로 결, 피지, 트러블 정돈',
    character: '효과 체감형 산 케어에 가깝기 때문에 장벽이 약한 피부는 빈도 조절이 중요합니다.',
    tags: ['산케어', '각질', '트러블'],
  },
  닥터지: {
    segment: '진정 수분 더마',
    focus: '병풀, 녹차, 판테놀로 붉음과 트러블 진정',
    character: '무겁지 않은 수분 크림 중심으로 홍조와 트러블을 함께 달래는 타입입니다.',
    tags: ['수분크림', '홍조', '진정'],
  },
  조선미녀: {
    segment: '한방 감성 데일리 선케어',
    focus: '쌀겨, 프로바이오틱스, 나이아신아마이드를 곁들인 편한 선케어',
    character: '백탁과 무거움을 줄인 데일리 선크림 성격이 강하고 사용감 접근성이 좋습니다.',
    tags: ['선케어', '데일리', '보습'],
  },
  이즈앤트리: {
    segment: '수분 성분 집중',
    focus: '여러 분자량 히알루론산과 진정 성분의 레이어링 보습',
    character: '수분 토너처럼 루틴 초반에 여러 겹 쌓아 건조감을 줄이는 제품에 적합합니다.',
    tags: ['수분토너', '히알루론산', '레이어링'],
  },
  구달: {
    segment: '비타민 톤 케어',
    focus: '비타민 C 유도체와 나이아신아마이드 기반 잡티, 칙칙함 케어',
    character: '민감 장벽 회복보다는 톤 개선과 광채 목표가 뚜렷한 기능성 브랜드 성격입니다.',
    tags: ['비타민C', '잡티', '광채'],
  },
  클레어스: {
    segment: '민감 입문 기능성',
    focus: '저농도 비타민 C와 진정 성분으로 시작하는 항산화 케어',
    character: '활성 성분을 처음 쓰는 민감 피부가 낮은 강도부터 적응하기 좋은 방향입니다.',
    tags: ['비타민C입문', '항산화', '저자극'],
  },
  퓨리토: {
    segment: '무향 진정·톤 밸런스',
    focus: '병풀, 나이아신아마이드, 판테놀을 조합한 순한 기능성',
    character: '진정만으로 부족하고 톤, 피지까지 같이 보고 싶을 때 부담을 낮춘 선택지입니다.',
    tags: ['무향', '병풀', '나이아신아마이드'],
  },
  메디힐: {
    segment: '즉각 진정 마스크',
    focus: '시트 마스크로 빠르게 공급하는 수분과 진정 에센스',
    character: '데일리 기본 루틴보다는 트러블이 올라온 날 단기 진정용으로 쓰기 좋은 브랜드입니다.',
    tags: ['마스크팩', '티트리', '응급진정'],
  },
}
